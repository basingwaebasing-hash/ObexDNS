...
| 用户登录 | 
|:---:|
| ![用户登录](docs/screenshots/dns.redsky-login.webp) | 

| 安装引导 | 端点配置 |
|:---:|:---:|
| ![设置引导](docs/screenshots/dns.redsky-setup.webp) | ![端点配置](docs/screenshots/dns.redsky-endpoints.webp) |

| 分析统计 | 解析目的地 |
|:---:|:---:|
| ![统计分析](docs/screenshots/dns.redsky-stats.webp) | ![解析目的地](docs/screenshots/dns.redsky-stats_dest.webp) |

| 本地规则管理 | 外部拦截列表 |
|:---:|:---:|
| ![规则设置](docs/screenshots/dns.redsky-rules.webp) | ![过滤列表](docs/screenshots/dns.redsky-filter.webp) |

| 解析日志 | 日志详情 |
|:---:|:---:|
| ![解析日志](docs/screenshots/dns.redsky-log.webp) | ![日志详情](docs/screenshots/dns.redsky-log_detail.webp) |

| 配置选项 | 配置选择 |
|:---:|:---:|
| ![高级设置](docs/screenshots/dns.redsky-settings.webp) | ![配置选择](docs/screenshots/dns.redsky-profile_select.webp) |

| 移动端日志 | 移动端统计 |
|:---:|:---:|
| ![移动端日志](docs/screenshots/dns.redsky-mobile_log.webp) | ![移动端统计](docs/screenshots/dns.redsky-mobile_stats.webp) |
...
2.  **创建 D1 数据库**：登录 Cloudflare 控制台，前往 `Workers & Pages` > `D1`，创建一个新的数据库（例如命名为 `redsky_db`），并复制所创建的数据库 ID。
