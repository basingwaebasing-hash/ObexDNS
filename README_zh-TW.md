...
| 使用者登入 |
|:---:|
| ![登入](docs/screenshots/dns.redsky-login.webp) |

| 安裝引導 | 端點配置 |
|:---:|:---:|
| ![設置引導](docs/screenshots/dns.redsky-setup.webp) | ![端點配置](docs/screenshots/dns.redsky-endpoints.webp) |

| 分析統計 | 解析目的地 |
|:---:|:---:|
| ![統計分析](docs/screenshots/dns.redsky-stats.webp) | ![解析目的地](docs/screenshots/dns.redsky-stats_dest.webp) |

| 本地規則管理 | 外部攔截清單 |
|:---:|:---:|
| ![規則設置](docs/screenshots/dns.redsky-rules.webp) | ![過濾清單](docs/screenshots/dns.redsky-filter.webp) |

| 解析日誌 | 日誌詳情 |
|:---:|:---:|
| ![解析日誌](docs/screenshots/dns.redsky-log.webp) | ![日誌詳情](docs/screenshots/dns.redsky-log_detail.webp) |

| 配置選項 | 配置選擇 |
|:---:|:---:|
| ![高級設置](docs/screenshots/dns.redsky-settings.webp) | ![配置選擇](docs/screenshots/dns.redsky-profile_select.webp) |

| 行動端日誌 | 行動端統計 |
|:---:|:---:|
| ![行動端日誌](docs/screenshots/dns.redsky-mobile_log.webp) | ![行動端統計](docs/screenshots/dns.redsky-mobile_stats.webp) |
...
2.  **建立 D1 資料庫**：登入 Cloudflare 控制台，前往 `Workers & Pages` > `D1`，建立一個新的資料庫（例如命名为 `redsky_db`），並複製所建立的資料庫 ID。
